...
class PDFProcessor:
    def __init__(self, db: Database):
        self.db = db
        self.columns = ["ata", "task_number", "description", "mpn", "pn", "limit_value", "margin", "reference"]
        self.mpn_patterns = []
        self.known_mpns = set()
        self.known_refs = []
        self.known_doc = ""
                ...
                for i, line in enumerate(lines):
                    ...
                    if task_number:
                        ...
                        for mpn, pn in mpn_pn_pairs:
                            ...
                            structured_data["task_number"].append(task_number)
                            structured_data["description"].append(desc)
                            structured_data["mpn"].append(mpn)
                            structured_data["pn"].append(pn)
                            structured_data["limit_value"].append(limit)
